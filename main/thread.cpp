...
void Thread_WriteResult (LPPTDATA data) {
	...
	WriteFile(t_file, output, (DWORD)strlen(output), &cnt, NULL); //Write - Path
	...
	WriteFile(t_file, output, (DWORD)strlen(output), &cnt, NULL); //Write - Start Time
	...
	WriteFile(t_file, output, (DWORD)strlen(output), &cnt, NULL); //Write - End Time
	...
	WriteFile(t_file, output, (DWORD)strlen(output), &cnt, NULL); //Write - Total Time
	...
	WriteFile(t_file, output, (DWORD)strlen(output), &cnt, NULL); //Write - Accumuulated Time
}
